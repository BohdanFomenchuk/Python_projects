...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\fomen\PycharmProjects\Weather_Alarm\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\fomen\PycharmProjects\Weather_Alarm\venv\Scripts\deactivate.nu'
